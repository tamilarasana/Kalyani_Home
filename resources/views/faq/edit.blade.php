                    ...
                    <div class="body">
                        <label for="title">Title</label>
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" id="title" class="form-control" name="title" value="{{ $faq->title }}"
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" id="answer" class="form-control" name="answer" value="{{ $faq->answer }}"
                            ...
                            <div class="form-group form-float">
                                <div class="fallback">
                                    ...
                                    <option value="unactive" @if($faq->status == 'unactive') selected @endif>Un Active</option>
                                    </select>
                                </div>
