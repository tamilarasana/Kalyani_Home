        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-6 col-sm-12">
                <ul class="breadcrumb float-md-right">
                    ...
                    <li class="breadcrumb-item">
                        <a href="javascript:void(0);">Exterior</a>
                    </li>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2> Exterior </h2>
                        <form action="{{ route('exterior.update', $exterior->id) }}" method="post"
                            ...
                            <div class="body">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" id="name" class="form-control" name="name"
                                            value="{{ $exterior->name }}" placeholder="Enter your Name" required>
                                    </div>
                                    @if ($errors->has('name'))
                                    ...
                                    <div class="fallback">
                                        <select class="form-control show-tick" name="product_id" required>
                                            @foreach ($product as $por)
                                                <option {{ $exterior->product_id === $por->id ? 'selected' : '' }}
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" id="position" class="form-control" name="position"
                                            value="{{ $exterior->position }}" placeholder="Enter your Position" required>
                                    </div>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <textarea rows="4" class="form-control no-resize" placeholder="Please type what you want..." name="description"
                                            required>{{ $exterior->description }}</textarea>
                                    </div>
                                ...
                                <div class="form-group form-float">
                                    <div class="fallback">
                                        ...
                                        <img src="{{ asset('storage/' . $exterior->image) }}" width="100"
                                            alt="Interior Image" title="Interior Image" />
                                    </div>
                                    @if ($errors->has('image'))
                                        <span class="text-danger">
                                ...
                                <div class="form-group form-float">
                                    <div class="fallback">
                                        <select class="form-control show-tick" name="status" required>
                                            ...
                                            <option value="active" @if ($exterior->status == 'active') selected @endif>Active
                                            </option>
                                            <option value="unactive" @if ($exterior->status == 'unactive') selected @endif>Un
                                                Active</option>
                                        </select>
                                    </div>
                                ...
                                <div class="card-action">
                                    ...
                                    <a href="{{ url('/exterior') }}" class="btn btn-danger">Cancel</a>
                                </div>
                            </div>
                        </form>
                    </div>
