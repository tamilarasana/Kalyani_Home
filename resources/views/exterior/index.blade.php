  ...
  <div class="container-fluid">
      <div class="row clearfix">
          <div class="col-lg-12 col-md-12 col-sm-12">
              <div class="card">
                  <div class="header">
                    <a href="{{ route('exterior.create') }}" class="btn  btn-sm btn-icon waves-effect waves-light btn-success float-right"
                                    ...
                                    <td>{{Str::limit($value->name, 10, $end='.....')}}</td>
                                     ...
                                     @if($value->status == "active")
                                          ...
                                          @else
                                            <td>Un Active</td>
                                          @endif
                                          <td><img src="{{ asset('storage/'.$value->image) }}" width="50" height="50" alt="" title="" /></td> 
                                    <td>
                                        <form action="{{ route('exterior.destroy',$value->id) }}" method="POST">       
                                            <a class="btn  btn-sm btn-icon  btn-info"  href="{{ route('exterior.edit',$value->id) }}" data-toggle="tooltip" data-original-title="Edit The Data"><i class="fa fa-edit"></i>
