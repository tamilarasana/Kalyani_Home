                    ...
                    <form action="{{ route('maplocation.update', $maplocation->id) }}" method="post"
                        ...
                        <div class="body">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" id="location_name" class="form-control" name="location_name" value="{{ $maplocation->location_name }}"
                                ...
                                <div class="fallback">
                                    <select class="form-control show-tick" name="product_id" required>
                                        ...
                                        @foreach ($product as $por)
                                                <option {{ $maplocation->product_id === $por->id ? 'selected' : '' }}
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" id="map_link" class="form-control" name="map_link" value="{{ $maplocation->map_link }}"
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" id="data" class="form-control" name="data" value="{{$maplocation->data }}"
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <textarea rows="4" class="form-control no-resize" placeholder="Please type what you want..." name="description"
                                        required>{{ $maplocation->description }}</textarea>
                                </div>
                            ...
                            <div class="form-group form-float">
                                <div class="fallback">
                                    <select class="form-control show-tick" name="status" required>
                                        ...
                                        <option value="active" @if ($maplocation->status == 'active') selected @endif>Active
                                        </option>
                                        <option value="unactive" @if ($maplocation->status == 'unactive') selected @endif>Un
                                            Active</option>
                                    </select>
                                </div>
