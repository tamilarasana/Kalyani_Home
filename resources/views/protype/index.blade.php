  ...
  <div class="container-fluid">
      <div class="row clearfix">
          <div class="col-lg-12 col-md-12 col-sm-12">
              <div class="card">
                  <div class="header">
                    <a href="{{ route('producttype.create') }}" class="btn  btn-sm btn-icon waves-effect waves-light btn-success float-right"
                          ...
                          <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                              ...
                              <tbody>
                                ...
                                <tr>
                                     ...
                                     <td>{{ $value->location->about_location }}</td>
                                     ...
                                     <td>{{Str::limit($value->description, 10, $end='.....')}}</td>
                                        @if($value->status == "active")
                                          ...
                                          @endif
                                    <td>
                                        <form action="{{ route('producttype.destroy',$value->id) }}" method="POST">       
                                            <a class="btn  btn-sm btn-icon  btn-info"  href="{{ route('producttype.edit',$value->id) }}" ><i class="fa fa-edit"></i>
