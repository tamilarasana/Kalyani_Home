        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    ...
                    <form action="{{ route('fullview.update', $fullview->id) }}" method="post"
                    ...
                    <div class="body">
                        <label for="name">Name</label>
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" id="name" class="form-control" name="name" value="{{ $fullview->name }}"
                                ...
                                <div class="fallback">
                                    <select class="form-control show-tick" name="product_id" required>
                                        ...
                                        @foreach ($product as $por)
                                                <option {{ $fullview->product_id === $por->id ? 'selected' : '' }}
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" id="position" class="form-control" name="position" value="{{$fullview->position  }}"
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <textarea rows="4" class="form-control no-resize" placeholder="Please type what you want..." name="description" required>{{ $fullview->description }}</textarea>
                                </div>
                            ...
                            <div class="form-group form-float">
                                <div class="fallback">
                                    ...
                                    <img src="{{ asset('storage/' . $fullview->image) }}" width="100"">
                                </div>
                                @if ($errors->has('image'))
                                <span class="text-danger">
                            ...
                            <div class="form-group form-float">
                                <div class="fallback">
                                    <select class="form-control show-tick" name="status">
                                        ...
                                        <option value="active" @if ($fullview->status == 'active') selected @endif>Active
                                        </option>
                                        <option value="unactive" @if ($fullview->status == 'unactive') selected @endif>Un
                                            Active</option>
                                    </select>
                                </div>
