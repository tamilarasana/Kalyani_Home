                                ...
                                <tbody>
                                    @foreach ($interior as $value)
                                        <tr>
                                            ...
                                            @endif
                                            <td>
                                                <form action="{{ route('interior.destroy', $value->id) }}" method="POST">
                                                    <a class="btn  btn-sm btn-icon  btn-info"
                                                        href="{{ route('interior.edit', $value->id) }}" data-toggle="tooltip"
                                                        data-original-title="Edit The Data"><i class="fa fa-edit"></i>
