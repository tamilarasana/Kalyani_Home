                            ...
                            <div class="body">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" id="name" class="form-control" name="name"
                                            value="{{ $interior->name }}" placeholder="Enter your Name" required>
                                    </div>
                                    @if ($errors->has('name'))
                                    ...
                                    <div class="fallback">
                                        <select class="form-control show-tick" name="product_id" required>
                                            @foreach ($product as $por)
                                                <option {{ $interior->product_id === $por->id ? 'selected' : '' }}
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" id="position" class="form-control" name="position"
                                            value="{{ $interior->position }}" placeholder="Enter your Position" required>
                                    </div>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <textarea rows="4" class="form-control no-resize" placeholder="Please type what you want..." name="description"
                                            required>{{ $interior->description }}</textarea>
                                    </div>
                                ...
                                <div class="form-group form-float">
                                    <div class="fallback">
                                        ...
                                        <img src="{{ asset('storage/' . $interior->image) }}" width="100"
                                ...
                                <div class="form-group form-float">
                                    <div class="fallback">
                                        <select class="form-control show-tick" name="status" required>
                                            ...
                                            <option value="active" @if ($interior->status == 'active') selected @endif>Active
                                            </option>
                                            <option value="unactive" @if ($interior->status == 'unactive') selected @endif>Un
                                                Active</option>
                                        </select>
                                    </div>
                                ...
                                <div class="card-action">
                                    ...
                                    <a href="{{ url('/interior') }}" class="btn btn-danger">Cancel</a>
                                </div>
                            </div>
                        </form>
                    </div>
