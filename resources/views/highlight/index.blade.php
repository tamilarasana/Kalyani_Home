  ...
  <div class="container-fluid">
      <div class="row clearfix">
          <div class="col-lg-12 col-md-12 col-sm-12">
              <div class="card">
                  <div class="header">
                    <a href="{{ route('highlight.create') }}" class="btn  btn-sm btn-icon waves-effect waves-light btn-success float-right"
                                    ...
                                    <td>{{Str::limit($value->name, 10, $end='.....')}}</td>
                                     ...
                                     {{-- <td>{{ $value->description }}</td> --}}
                                        @if($value->status == "active")
                                          ...
                                          @endif
                                    <td>
                                        <form action="{{ route('highlight.destroy',$value->id) }}" method="POST">       
                                            <a class="btn  btn-sm btn-icon waves-effect waves-light btn-info"  href="{{ route('highlight.edit',$value->id) }}" data-toggle="tooltip" data-original-title="Edit The Data"><i class="fa fa-edit"></i>
                                            </i></a>
                                            @csrf
                                            @method('DELETE')
