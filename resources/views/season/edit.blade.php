                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" id="name" class="form-control" name="season_name"
                                            value="{{ $season->season_name }}" placeholder="Enter your Name" required>
                                    </div>
                                    ...
                                    <div class="fallback">
                                        <select class="form-control show-tick" name="product_id" required>
                                            @foreach ($product as $por)
                                                <option {{ $season->product_id === $por->id ? 'selected' : '' }}
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <textarea rows="4" class="form-control no-resize" placeholder="Please type what you want..." name="description"
                                            required>{{ $season->description }}</textarea>
                                    </div>
                                ...
                                <div class="form-group form-float">
                                    <div class="fallback">
                                        <select class="form-control show-tick" name="status" required>
                                            ...
                                            <option value="active" @if ($season->status == 'active') selected @endif>Active
                                            </option>
                                            <option value="unactive" @if ($season->status == 'unactive') selected @endif>Un
                                                Active</option>
                                        </select>
                                    </div>
