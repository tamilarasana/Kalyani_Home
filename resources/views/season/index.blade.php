  ...
  <div class="container-fluid">
      <div class="row clearfix">
          <div class="col-lg-12 col-md-12 col-sm-12">
              <div class="card">
                  <div class="header">
                    <a href="{{ route('season.create') }}" class="btn  btn-sm btn-icon waves-effect waves-light btn-success float-right"
                      ...
                      <div class="table-responsive">
                          <table class="table table-bordered table-condensed table-hover js-basic-example dataTable">
                              ...
                              <tbody>
                                ...
                                <tr>
                                     {{-- <td>{{ $value->name }}</td> --}}
                                     <td>{{Str::limit($value->season_name, 10, $end='.....')}}</td>
                                     ...
                                     <td>{{Str::limit($value->description, 10, $end='.....')}}</td>
                                        @if($value->status == "active")
                                          ...
                                          @endif
                                    <td>
                                        <form action="{{ route('season.destroy',$value->id) }}" method="POST">       
                                            <a class="btn  btn-sm btn-icon  btn-info"  href="{{ route('season.edit',$value->id) }}" ><i class="fa fa-edit"></i>
                                            </i></a>
                                            @csrf
                                            @method('DELETE')
