  ...
  <div class="container-fluid">
      <div class="row clearfix">
          <div class="col-lg-12 col-md-12 col-sm-12">
              <div class="card">
                  <div class="header">
                    <a href="{{ route('category.create') }}" class="btn  btn-sm btn-icon waves-effect waves-light btn-success float-right"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('category.destroy',$value->id) }}" method="POST">       
                                            <a class="btn  btn-sm btn-icon btn-info"  href="{{ route('category.edit',$value->id) }}" ><i class="fa fa-edit"></i>
                                            </i></a>
                                            @csrf
                                            @method('DELETE')
