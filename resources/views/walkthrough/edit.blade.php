            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        ...
                        <form action="{{ route('walkthroughvedio.update', $walkthroughvedio->id) }}" method="post"
                    ...
                    <div class="body">
                        <label for="status">Name</label>
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" id="name" class="form-control" name="name" value="{{ $walkthroughvedio->name }}"
                            ...
                            <div class="form-group form-float">
                                <div class="fallback">
                                    <select class="form-control show-tick" name="product_id" required>
                                        ...
                                        <option  {{ $walkthroughvedio->product_id === $por->id? 'selected' : ''}}  value="{{$por->id}}">{{$por->product_name}}</option>
                                     @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" id="position" class="form-control" name="position" value="{{ $walkthroughvedio->position }}"
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <textarea rows="4" class="form-control no-resize" placeholder="Please type what you want..." name="description" required>{{ $walkthroughvedio->description }}</textarea>
                                </div>
                            ...
                            <div class="form-group form-float">
                                <div class="fallback">
                                    ...
                                    <img src="{{ asset('storage/'.$walkthroughvedio->file) }}" width="100" alt="walkthroughvedio Image" title="walkthroughvedio Image" />
                                </div>
                                @if ($errors->has('file'))
                                <span class="text-danger">
                            ...
                            <div class="form-group form-float">
                                <div class="fallback">
                                    <select class="form-control show-tick" name="status">
                                        ...
                                        <option value="active" @if($walkthroughvedio->status == 'active') selected @endif>Active</option>
                                    <option value="unactive" @if($walkthroughvedio->status == 'unactive') selected @endif>Un Active</option>
                                    </select>
                                </div>
