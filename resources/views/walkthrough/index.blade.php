      ...
      <div class="row">
          ...
          <div class="col-lg-5 col-md-6 col-sm-12">
              <ul class="breadcrumb float-md-right">
                  ...
                  <li class="breadcrumb-item active">Walkthrough Vedio </li>
              </ul>
          </div>
      </div>
  </div>
  <div class="container-fluid">
      <div class="row clearfix">
          <div class="col-lg-12 col-md-12 col-sm-12">
              <div class="card">
                  <div class="header">
                    <a href="{{ route('walkthroughvedio.create') }}" class="btn  btn-sm btn-icon waves-effect waves-light btn-success float-right"
                  ...
                  <div class="body">
                      <div class="table-responsive">
                          <table class="table table-bordered table-condensed table-hover js-basic-example dataTable">
                              ...
                              <tbody>
                                @foreach($walkthroughvedio as $value)					
                                <tr>
                                     {{-- <td>{{ $value->name }}</td> --}}
                                     ...
                                     <td>{{Str::limit($value->description, 10, $end='.....')}}</td>
                                        @if($value->status == "active")
                                          ...
                                          @else
                                            <td>Un Active</td>
                                          @endif
                                          <td><img src="{{ asset('storage/'.$value->file) }}" width="50" alt="" title="" /></td> 
                                    <td>
                                        <form action="{{ route('walkthroughvedio.destroy',$value->id) }}" method="POST">       
                                            <a class="btn  btn-sm btn-icon  btn-info"  href="{{ route('walkthroughvedio.edit',$value->id) }}" ><i class="fa fa-edit"></i>
