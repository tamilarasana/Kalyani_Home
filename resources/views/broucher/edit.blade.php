        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-6 col-sm-12">
                <ul class="breadcrumb float-md-right">
                    ...
                    <li class="breadcrumb-item">
                        <a href="javascript:void(0);">Broucher</a>
                    </li>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2> Broucher </h2>
                        <form action="{{ route('broucher.update', $broucher->id) }}" method="post"
                            ...
                            <div class="body">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="name" class="form-control" name="name"
                                            value="{{ $broucher->name }}" placeholder="Enter your Name" required>
                                    </div>
                                    @if ($errors->has('name'))
                                    ...
                                    <div class="fallback">
                                        <select class="form-control show-tick" name="product_id" required>
                                            @foreach ($product as $por)
                                                <option {{ $broucher->product_id === $por->id ? 'selected' : '' }}
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <textarea rows="4" class="form-control no-resize" placeholder="Please type what you want..." name="description"
                                            required>{{ $broucher->description }}</textarea>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="fallback">
                                        ...
                                        <img src="{{ asset('storage/' . $broucher->file) }}" width="100"
                                            alt="broucher Image" title="broucher Image" />
                                    </div>
                                    @if ($errors->has('file'))
                                    <span class="text-danger">
                                ...
                                <div class="form-group">
                                    <div class="fallback">
                                        <select class="form-control show-tick" name="status">
                                            ...
                                            <option value="active" @if ($broucher->status == 'active') selected @endif>Active
                                            </option>
                                            <option value="unactive" @if ($broucher->status == 'unactive') selected @endif>Un
                                                Active</option>
                                        </select>
                                    </div>
                                ...
                                <div class="card-action">
                                    ...
                                    <a href="{{ url('/broucher') }}" class="btn btn-danger">Cancel</a>
                                </div>
                            </div>
                        </form>
                    </div>
