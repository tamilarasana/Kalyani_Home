        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    ...
                    <form action="{{URL::to('broucher')}}" method = "post"  id="form_validation" enctype="multipart/form-data">
                        {{csrf_field()}}
                    <div class="body">
                        <label for="name">Name</label>
                            ...
                            <div class="form-group">
                                <div class="fallback">
                                    <input type="file" id="image" class="form-control" name="file" multiple required/>
                                </div>
                                @if ($errors->has('file'))
                                <span class="text-danger">
