  ...
  <div class="container-fluid">
      <div class="row clearfix">
          <div class="col-lg-12 col-md-12 col-sm-12">
              <div class="card">
                  <div class="header">
                    <a href="{{ route('amentities.create') }}" class="btn  btn-sm btn-icon waves-effect waves-light btn-success float-right"
                                ...
                                <tr>
                                     ...
                                     <td>{{Str::limit($value->description, 10, $end='.....')}}</td>
                                        @if($value->status == "active")
                                          ...
                                          @endif
                                    <td>
                                        <form action="{{ route('amentities.destroy',$value->id) }}" method="POST">       
                                            <a class="btn  btn-sm btn-icon waves-effect waves-light btn-info"  href="{{ route('amentities.edit',$value->id) }}" ><i class="fa fa-edit"></i>
                                            </i></a>
                                            @csrf
                                            @method('DELETE')
                                
                                            <button type="submit" class="btn btn-sm btn-icon waves-effect waves-light btn-danger"  ><i class="fa fa-trash-o" ></i></button>
                                        </form>
                                    </td>
                                </tr>
                                 @endforeach
